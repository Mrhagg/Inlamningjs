...
import Membersimg from '../../../../components/Extras/Membersimg'
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="members">
        <Membersimg image={img_Kristine} title="Kristine Palmer" text="Chef Operation Officer" />
        <Membersimg image={img_Mark} title="Mark Aubri" text="Senior Consultant" />
        <Membersimg image={img_Kimberly} title="Kimberly Hansen" text="Senior Consultant" />
        <Membersimg image={img_Justin} title="Justin Willoman" text="Senior Tech Consultant" />
      </div>
