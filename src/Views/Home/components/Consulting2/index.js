      ...
      <div className="consulting-container">
       <SectionTitle className="container-texts" title="Why Choose Us" description="We Provide The Best Service for Consulting" />
        <div className="parent-box">
          ...
          <BoxService className="yellow" titel="Business Advice" description="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis in nam possimus" url="/services/startupbusiness" />
          <BoxService className="white" titel="Business Advice" description="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis in nam possimus" url="/services/financialadvice" />
          <BoxService className="white" titel="Business Advice" description="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis in nam possimus" url="/services/riskmanagment" />
        </div>
